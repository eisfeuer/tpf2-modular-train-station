...
describe('TallPlatformStationPattern', function ()
    describe('getTypeAndModule', function ()
        ...
        it ('it returns grid types and modules (prefer island even)', function ()
            local pattern = TallPlatformStationPattern:new{trackModule = 'track.module', platformModule = 'platform.module', trackCount = 4, horizontalSize = 1, preferIslandPlatforms = true}
        ...
        it ('it returns grid types and modules (prefer island odd)', function ()
            local pattern = TallPlatformStationPattern:new{trackModule = 'track.module', platformModule = 'platform.module', trackCount = 5, horizontalSize = 1, preferIslandPlatforms = true}
