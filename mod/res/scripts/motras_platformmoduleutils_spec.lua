...
describe('PlatformModuleUtils', function ()
    ...
    describe('addHallRoofSlots', function ()
        it ('adds start and end slot', function ()
            ...
            platform:addAssetSlot(expectedSlots, 53, {
                assetType = t.ROOF,
            ...
            platform:addAssetSlot(expectedSlots, 54, {
                assetType = t.ROOF,
                slotType = 'motras_hall_roof',
                position = {0, 2.5, 1},
                rotation = 0,
            ...
            PlatformModuleUtils.addHallRoofSlots(platform, slots)

            assert.are.same(expectedSlots, slots)
        end)

        it ('adds end slots only when platform has bottom neighbor', function ()
            local slots = {}
            local expectedSlots = {}
